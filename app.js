/* SangamHub — Where Developers Confluence
...
const REPOS = [
  {
    ...
    owner: 'prashanth_dev',
    name: 'VED-MODELS',
    desc: 'Neural network models for student performance prediction using PyTorch & NumPy. Trained on Indian education datasets — a confluence of data and discovery.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 482,
    forks: 97,
    updated: '2 hours ago',
    tags: ['machine-learning', 'pytorch', 'education', 'sangam'],
  ...
  },
  {
    ...
    name: 'triveni-sdk',
    desc: 'Unified SDK for Aadhaar, UPI and DigiLocker — three streams converging into one. Like the Triveni Sangam, three IndiaStack APIs meet here.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1243,
    forks: 318,
    updated: '5 hours ago',
    tags: ['indiastack', 'triveni', 'fintech', 'open-api'],
  ...
  },
  {
    ...
    owner: 'mumbai_coder',
    name: 'sangam-react',
    desc: 'A React component library inspired by classical Indian design — mandala patterns, lotus motifs, rangoli grids, and full Indic script support.',
    lang: 'TypeScript',
    langColor: '#3178c6',
    stars: 3871,
    forks: 642,
    updated: '1 day ago',
    tags: ['react', 'ui-library', 'mandala', 'indic-scripts'],
  ...
  },
  {
    ...
    owner: 'fintech_india',
    name: 'ganga-pay',
    desc: 'Open-source UPI payment gateway — pure and flowing like the Ganga. Supports NPCI, PhonePe, GPay and Paytm flows with a clean streaming API.',
    lang: 'JavaScript',
    langColor: '#f1e05a',
    stars: 2105,
    forks: 430,
    updated: '3 days ago',
    tags: ['upi', 'payments', 'ganga', 'fintech'],
  ...
  },
  {
    ...
    owner: 'agro_tech',
    name: 'kisan-ai',
    desc: 'AI-powered crop disease detection and yield prediction. Multi-lingual support (Hindi, Marathi, Punjabi, Tamil) — knowledge flowing to every farmer.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1680,
    forks: 287,
  ...
  },
  {
    id: 'prayagraj-cloud',
    owner: 'cloud_india',
    name: 'prayagraj-cloud',
    desc: 'Infrastructure-as-code at the confluence — Terraform modules for Indian cloud providers (Jio Cloud, BSNL, NIC). Named after the city of Sangam.',
    lang: 'Go',
    langColor: '#00ADD8',
    stars: 920,
    forks: 156,
    updated: '2 weeks ago',
    tags: ['cloud', 'terraform', 'prayagraj', 'digital-india'],
...
const TRENDING = [
  {
    ...
    name: 'sangam-react',
    owner: 'mumbai_coder',
    desc: 'React UI library with classical Indian Sangam design language and full Indic script support.',
    lang: 'TypeScript',
    langColor: '#3178c6',
    stars: 3871,
    starsToday: 284,
  ...
  },
  {
    ...
    name: 'ganga-pay',
    owner: 'fintech_india',
    desc: 'Open-source UPI & NPCI payment integrations — pure and flowing like the sacred Ganga.',
    lang: 'JavaScript',
    langColor: '#f1e05a',
    stars: 2105,
    starsToday: 201,
  ...
  },
  {
    ...
    name: 'kisan-ai',
    owner: 'agro_tech',
    desc: 'Crop disease detection AI trained on 50,000+ Indian farm images — knowledge for every ghat.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1680,
    starsToday: 156,
  ...
  },
  {
    ...
    name: 'triveni-sdk',
    owner: 'digital_bharat',
    desc: 'Three IndiaStack rivers (Aadhaar, UPI, DigiLocker) converging into one SDK.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1243,
    starsToday: 98,
  ...
  },
  {
    ...
    name: 'prayagraj-cloud',
    owner: 'cloud_india',
    desc: 'Terraform modules for India-first cloud deployments, named after the city of Sangam.',
    lang: 'Go',
    langColor: '#00ADD8',
    stars: 920,
    starsToday: 74,
  ...
  },
  {
    ...
    name: 'VED-MODELS',
    owner: 'prashanth_dev',
    desc: 'PyTorch models for predicting student outcomes — ancient Vedic pursuit of knowledge meets AI.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 482,
    starsToday: 41,
