...
const REPOS = [
  ...
  },
  {
    ...
    owner: 'csuite_india',
    name: 'bharat-ceo-ai',
    desc: 'AI agent that simulates a Chief Executive Officer — strategic planning, stakeholder communication, OKR setting, and executive decision-making for Indian startups and enterprises.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1540,
    forks: 312,
    updated: '1 day ago',
    tags: ['ceo', 'ai-agent', 'strategy', 'executive-ai', 'llm'],
    files: ['README.md', 'agent/', 'prompts/', 'examples/', 'requirements.txt', 'run_ceo.py']
  },
  {
    id: 'bharat-cto-ai',
    owner: 'csuite_india',
    name: 'bharat-cto-ai',
    desc: 'AI agent acting as a Chief Technology Officer — tech roadmap design, architecture reviews, engineering team guidance, and build-vs-buy decisions tailored to Indian tech ecosystems.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1876,
    forks: 389,
    updated: '6 hours ago',
    tags: ['cto', 'ai-agent', 'tech-strategy', 'executive-ai', 'llm'],
    files: ['README.md', 'agent/', 'prompts/', 'evaluations/', 'requirements.txt', 'run_cto.py']
  },
  {
    id: 'bharat-cmo-ai',
    owner: 'csuite_india',
    name: 'bharat-cmo-ai',
    desc: 'AI agent acting as a Chief Marketing Officer — go-to-market strategy, brand positioning, digital campaign planning, and consumer-insights analysis for Indian markets.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1123,
    forks: 241,
    updated: '2 days ago',
    tags: ['cmo', 'ai-agent', 'marketing', 'executive-ai', 'llm'],
    files: ['README.md', 'agent/', 'prompts/', 'campaigns/', 'requirements.txt', 'run_cmo.py']
  },
  {
    id: 'bharat-cfo-ai',
    owner: 'csuite_india',
    name: 'bharat-cfo-ai',
    desc: 'AI agent acting as a Chief Financial Officer — financial modelling, budget forecasting, fundraising pitch analysis, GST/compliance guidance, and unit-economics review for Indian businesses.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 987,
    forks: 198,
    updated: '3 days ago',
    tags: ['cfo', 'ai-agent', 'finance', 'executive-ai', 'llm'],
    files: ['README.md', 'agent/', 'prompts/', 'models/', 'requirements.txt', 'run_cfo.py']
  },
];
...
const TRENDING = [
  ...
  },
  {
    ...
    name: 'bharat-cto-ai',
    owner: 'csuite_india',
    desc: 'AI agent acting as a CTO — tech roadmap, architecture reviews, and engineering guidance for Indian companies.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1876,
    starsToday: 174,
  ...
  },
  {
    ...
    name: 'bharat-ceo-ai',
    owner: 'csuite_india',
    desc: 'AI agent acting as a CEO — strategy, OKRs, and executive decision-making for Indian startups.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1540,
    starsToday: 138,
  ...
  },
  {
    ...
    name: 'bharat-cmo-ai',
    owner: 'csuite_india',
    desc: 'AI agent acting as a CMO — go-to-market, brand positioning, and campaigns for Indian markets.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 1123,
    starsToday: 97,
  ...
  },
  {
    ...
    name: 'bharat-cfo-ai',
    owner: 'csuite_india',
    desc: 'AI agent acting as a CFO — financial modelling, budgets, GST compliance, and fundraising analysis.',
    lang: 'Python',
    langColor: '#3572A5',
    stars: 987,
    starsToday: 82,
